...
st.sidebar.write("Aplicação para buscar endereço a partir do seu CEP e mostrar a localização no mapa!")
    ...
    if st.button("Buscar"):
        if len(cep) != 8 or not cep.isdigit():
            ...
            try:
                ...
                st.error(f"Ocorreu um error ao buscar o CEP: {e}")
